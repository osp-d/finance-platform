    ...
    <div className="flex h-screen flex-col justify-between">
      ...
      <div className="flex justify-between px-14 py-10">
        <div className="flex w-96 flex-col gap-7">
          ...
          <p>
            Effortlessly track your transactions and gain powerful insights into
            your financial data. See where your money goes, visualize trends,
            and take control of your financial future—all in one intuitive
            platform.
          </p>
      ...
      <div className="flex items-center justify-between px-14 py-10">
        <div className="flex w-96 flex-col gap-7">
          ...
          <p>
            Tailor the platform to fit your unique financial goals. Your data is
            encrypted and privacy is our top priority.
          </p>
        </div>
        <div className="h-[450px] w-[600px] rounded-2xl bg-slate-200"></div>
      </div>
